...
func (s *blockWiseSender) coapType() coap.COAPType {
	if s.peerDrive {
...
func (s *blockWiseSender) sizeType() coap.OptionID {
	if s.blockType == coap.Block2 {
		return coap.Size2
	}
	return coap.Size1
}
...
func (b *blockWiseSession) sendErrorMsg(code coap.COAPCode, typ coap.COAPType, token []byte, MessageID uint16, err error) {
...
func (r *blockWiseReceiver) sizeType() coap.OptionID {
...
func (r *blockWiseReceiver) coapType() coap.COAPType {
	if r.peerDrive {
